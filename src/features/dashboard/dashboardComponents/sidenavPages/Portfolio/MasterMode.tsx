...
const MasterMode = ({
    ...
    <div>
      <div className='flex items-center justify-between gap-3 mt-8 mb-3'>
        <div className='flex items-center gap-3'>
          ...
          ></span>
          <span className='text-[14px] tracking-[0.2em] text-white font-[900]'>
            Pinned Master Vault
          </span>
        </div>
  ...
  {vault.walletSnippet}
          ...
          <div className='flex justify-between items-center bg-[#102221] border-[1.2px] border-[#18312b] rounded-xl p-5'>
            ...
            <button className='bg-[#FE9A00]     shadow-[0_6px_12px_rgba(254,154,0,0.6)] text-black px-8 py-3 rounded-xl font-bold tracking-[0.15em] hover:brightness-110 transition'>
              CLAIM EARNING FEES ↗
            </button>
          </div>
        </div>
